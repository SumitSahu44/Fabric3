            ...
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-8" encType="multipart/form-data">
              ...
              <div className="grid md:grid-cols-2 gap-8">
                <div className="relative border-b border-slate-200 pb-2 focus-within:border-orange-600 transition-all">
                  ...
                  <input type="text" {...register("traderName", { required: true })} className="w-full bg-transparent border-none outline-none py-2 text-xs font-bold uppercase tracking-widest" placeholder="John Doe" />
                ...
                <div className="relative border-b border-slate-200 pb-2 focus-within:border-orange-600 transition-all">
                  ...
                  <input type="text" {...register("businessName", { required: true })} className="w-full bg-transparent border-none outline-none py-2 text-xs font-bold uppercase tracking-widest" placeholder="Textile Corp" />
              ...
              <div className="relative border-b border-slate-200 pb-2 focus-within:border-orange-600 transition-all">
                ...
                <input type="text" {...register("businessAddress", { required: true })} className="w-full bg-transparent border-none outline-none py-2 text-xs font-bold uppercase tracking-widest" placeholder="Full address" />
              ...
              <div className="grid md:grid-cols-2 gap-8">
                <div className="relative border-b border-slate-200 pb-2 focus-within:border-orange-600 transition-all">
                  ...
                  <select {...register("enquiryType", { required: true })} className="w-full bg-transparent border-none outline-none pt-2 pb-1 text-xs font-bold tracking-widest appearance-none cursor-pointer text-slate-900 border-l border-slate-50 pl-1">
                  ...
                  {errors.enquiryType && <span className="text-red-500 text-[9px] uppercase tracking-widest font-black absolute bottom-0 right-0 py-2">Required</span>}
                </div>
              ...
              <button type="submit" disabled={loading} className="w-full bg-slate-900 text-white flex gap-2 justify-center py-5 font-black uppercase text-[11px] tracking-[0.3em] hover:bg-orange-600 transition-all shadow-xl disabled:opacity-70 disabled:cursor-not-allowed">
