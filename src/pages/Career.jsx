    ...
    <div className="bg-slate-50 min-h-screen pt-32 pb-24 px-6 selection:bg-orange-100">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="mb-12 flex items-center justify-between gap-6">
          <div>
            <h2 className="text-xs font-black uppercase tracking-[0.2em] text-slate-600">Open Positions</h2>
            ...
            >
              <div className="space-y-2">
                ...
                <div className="flex gap-6 pt-2">
                  <span className="flex items-center gap-2 text-[11px] font-bold text-slate-400 uppercase tracking-widest"><MapPin size={12}/> {job.loc}</span>
                  <span className="flex items-center gap-2 text-[11px] font-bold text-slate-400 uppercase tracking-widest"><Clock size={12}/> {job.type}</span>
                </div>
              </div>
              <div className="mt-8 md:mt-0 flex items-center gap-6">
                <span className="text-[11px] font-black uppercase tracking-widest text-slate-400 opacity-0 group-hover:opacity-100 transition-opacity">Apply</span>
        ...
        <div className="mt-24 p-12 bg-white border border-slate-100 flex flex-col md:flex-row justify-between items-center gap-8 shadow-sm">
          <div>
            ...
            <p className="text-xs text-slate-600 max-w-md uppercase tracking-widest leading-relaxed">Submit your profile to our talent database for future opportunities.</p>
          </div>
          <button className="bg-transparent border border-slate-900 text-slate-900 px-10 py-5 font-black uppercase text-[11px] tracking-[0.3em] hover:bg-slate-900 hover:text-white transition-all shadow-md">
            Upload Resume
          </button>
        </div>
        ...
        <footer className="mt-20 pt-10 border-t border-slate-100 text-center">
          <p className="text-[11px] uppercase tracking-widest text-slate-400 opacity-60">Parekh Fabrics Careers Ahmedabad | Equal Opportunity Employer | Mobile Responsive & All Browser Support</p>
        </footer>
      </div>
    </div>
  );
