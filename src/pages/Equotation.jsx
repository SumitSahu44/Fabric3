...
import { Calculator, ClipboardCheck, ArrowRight, ShieldCheck, CheckCircle, Mail, Phone } from 'lucide-react';
        ...
        <div className="grid lg:grid-cols-3 gap-12">
          ...
          <div className="lg:col-span-2 bg-white border border-slate-100 shadow-2xl p-8 md:p-14 relative">
             ...
             <form onSubmit={handleSubmit(onSubmit)} className="space-y-8">
                ...
                <div className="relative border-b border-slate-200 pb-2 focus-within:border-orange-600 transition-all">
                  <label className="text-[9px] font-black text-slate-400 uppercase tracking-widest">Options (Roll-down mode) *</label>
